...
export default function ContactSalesPage() {
  return (
    <Container className="py-24 sm:py-32">
      ...
      <a href={`mailto:${COMPANY.supportEmail}?subject=${encodeURIComponent("ClientTurn sales enquiry")}`} className="mt-10 inline-flex h-12 items-center gap-3 rounded-md bg-primary px-6 text-sm font-semibold text-on-primary hover:bg-primary-hover">Email the team <ArrowUpRight size={17} aria-hidden /></a>
      <p className="mt-4 text-sm text-content-muted">{COMPANY.supportEmail}</p>
