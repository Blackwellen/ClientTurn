...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      affiliate_commissions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "affiliate_commissions_reversal_of_id_fkey"
      ...
      affiliate_links: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "affiliate_links_promo_code_id_fkey"
            columns: ["promo_code_id"]
            isOneToOne: false
            referencedRelation: "affiliate_promo_codes"
            referencedColumns: ["id"]
      ...
      affiliate_promo_codes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "affiliate_promo_codes_offer_id_fkey"
            columns: ["offer_id"]
            isOneToOne: false
            referencedRelation: "affiliate_promo_offers"
            referencedColumns: ["id"]
          },
        ]
      }
      affiliate_promo_offers: {
        Row: {
          active: boolean
          created_at: string
          description: string
      ...
      affiliate_referrals: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "affiliate_referrals_promo_code_id_fkey"
            columns: ["promo_code_id"]
            isOneToOne: false
            referencedRelation: "affiliate_promo_codes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "affiliate_referrals_source_link_id_fkey"
      ...
      affiliate_resource_saves: {
        ...
        Relationships: [
          {
            foreignKeyName: "affiliate_resource_saves_affiliate_id_fkey"
            columns: ["affiliate_id"]
            isOneToOne: false
            referencedRelation: "affiliates"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "affiliate_resource_saves_resource_id_fkey"
            columns: ["resource_id"]
            isOneToOne: false
            referencedRelation: "affiliate_resources"
            referencedColumns: ["id"]
      ...
      affiliate_resources: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "affiliate_resources_supersedes_resource_id_fkey"
            columns: ["supersedes_resource_id"]
            isOneToOne: false
            referencedRelation: "affiliate_resources"
            referencedColumns: ["id"]
          },
      ...
      affiliates: {
        Row: {
          ...
          display_name: string
          id: string
          identity_address_state: string | null
          identity_checked_at: string | null
          identity_document_state: string | null
          identity_selfie_state: string | null
      ...
      billing_credit_entries: {
        ...
        Relationships: [
          {
            foreignKeyName: "billing_credit_entries_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "billing_credit_entries_reverses_entry_id_fkey"
            columns: ["reverses_entry_id"]
            isOneToOne: false
            referencedRelation: "billing_credit_entries"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      business_data_controls: {
        Row: {
          ...
          basis_reviewed_at: string | null
          business_id: string
          created_at: string
          dpo_contact: string | null
          lawful_basis_note: string | null
          legal_name: string | null
          marketing_lawful_basis: string
        ...
        Relationships: [
          {
            foreignKeyName: "business_data_controls_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: true
            referencedRelation: "businesses"
            referencedColumns: ["id"]
      ...
      business_profiles: {
        Row: {
          ...
          outreach_guidance_updated_at: string | null
      ...
      business_settings: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "business_settings_default_sender_identity_id_fkey"
      ...
      connector_event_failures: {
        ...
        Relationships: [
          {
            foreignKeyName: "connector_event_failures_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "connector_event_failures_install_id_fkey"
            columns: ["install_id"]
            isOneToOne: false
      ...
      copilot_actions: {
        ...
        Relationships: [
          {
            foreignKeyName: "copilot_actions_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
      ...
      copilot_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "copilot_messages_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
      ...
      copilot_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "copilot_sessions_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
      ...
      social_action_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "social_action_log_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "social_action_log_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "social_action_log_prospect_id_fkey"
            columns: ["prospect_id"]
            isOneToOne: false
            referencedRelation: "prospects"
            referencedColumns: ["id"]
      ...
      social_sending_accounts: {
        Row: {
          ...
          created_at: string
          created_by: string | null
          daily_connect_cap: number | null
          daily_message_cap: number | null
          display_name: string
          external_handle: string | null
          id: string
          monthly_note_cap: number | null
          platform: string
          ...
          status: string
          updated_at: string
          weekly_connect_cap: number | null
        }
        Insert: {
          account_tier?: string
          business_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "social_sending_accounts_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
      ...
      usage_events: {
        Row: {
          adjusts_operation_id: string | null
          business_id: string
    ...
    Functions: {
      ...
      record_connector_event_failure: {
        Args: {
