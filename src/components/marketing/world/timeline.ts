...
const routes: Point3[][] = [
  ...
  [[-5, 3.5, -1.7], [-4.1, 1.7, -0.95], [-2.86, 0, 0], [-1.04, 0, 0], [-0.9, 0.35, 0.05], [-0.53, 0.65, 0.15], [0.6, 0.95, -0.4], [1.74, 0.72, 0.05], [1.47, 0.1, 0.05], [3.63, 0.1, 0.05], [4.5, -1.1, 0.4], [3.5, -3.8, 0.4]],
  /* 05 · Reactivation — runs under the archive, never through it, then lifts into the live reply. */
  [[-4.5, 3.3, -2.1], [-4, 1.3, -1.25], [-3.65, -0.6, -0.2], [-3.3, -1.16, 0.6], [-1.6, -1.22, 0.75], [0.2, -1.24, 0.75], [1.05, -1.12, 0.72], [1.32, -0.66, 0.5], [1.26, -0.16, 0.35], [3.1, -0.16, 0.35], [3.9, -1.4, 0.5], [2.6, -4.8, 0.1]],
...
const arrivals: Point3[] = [
  [-1.1, -5.6, 1.7], [2.95, -0.9, 0.3], [-1.61, -0.2, 0.5], [1.82, 1.05, 0.3], [1.47, 0.1, 0.05], [1.26, -0.16, 0.35], [0, -1.35, 0.5],
];
